...
class OtherUserProfileWealthLevelWidget extends StatelessWidget {
  const OtherUserProfileWealthLevelWidget({
    super.key,
  });
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: PreviewWealthLevelImage(
                    height: 30,
                    width: 50,
                    image: OtherUserProfileBottomSheet.otherUserProfileModel?.user?.wealthLevel?.levelImage,
                  ),
                ),
                10.width,
              ],
