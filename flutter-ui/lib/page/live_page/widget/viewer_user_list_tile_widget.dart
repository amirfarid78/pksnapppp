...
class ViewerUserListTileWidget extends StatefulWidget {
  const ViewerUserListTileWidget({
    super.key,
    required this.index,
    this.indexData,
  });
  ...
  @override
  State<ViewerUserListTileWidget> createState() => _ViewerUserListTileWidgetState();
}

class _ViewerUserListTileWidgetState extends State<ViewerUserListTileWidget> {
