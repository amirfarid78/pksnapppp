...
class CustomRangePicker {
  static Future<DateTimeRange?> onShow(BuildContext context) async {
    return await showRangePickerDialog(
      ...
      barrierColor: AppColor.black.withAlpha(204),
      enabledCellsTextStyle: AppFontStyle.styleW500(AppColor.black, 16),
      disabledCellsTextStyle: AppFontStyle.styleW500(AppColor.grayText, 16),
      ...
      daysOfTheWeekTextStyle: AppFontStyle.styleW500(AppColor.black.withAlpha(153), 14),
